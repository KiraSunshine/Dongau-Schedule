...
- Раздел готовится для ДонГУ: сервис свободных аудиторий пока недоступен. ([API](FREE_ROOMS_API.md))
...
- **Свободные аудитории:** планируется; собственная база будет собираться CI из расписания ([FREE_ROOMS_API.md](FREE_ROOMS_API.md)).
