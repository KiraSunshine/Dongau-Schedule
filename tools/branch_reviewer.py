...
"""
Branch AI Reviewer & Diff Analyzer for Dongau-Schedule
...
def query_ai_review(git_info):
    ...
    system_prompt = """Ты — ведущий мобильный архитектор открытого проекта Dongau-Schedule (Kotlin Multiplatform + Compose Multiplatform для Android и iOS).
...
def generate_report(git_info, domain_analysis, heuristics, ai_review):
    ...
    lines.append("---")
    lines.append("*💡 Сгенерировано автоматически инструментом Branch AI Reviewer для проекта Dongau-Schedule.*\n")
