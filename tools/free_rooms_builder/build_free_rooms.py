...
BASE_API_URL = "https://edu.dongau.ru/schedule/api"
...
def main():
    ...
    if not rooms_meta:
        print("[Ошибка] Не удалось получить аудитории от сервера ДонГУ (возможна гео-блокировка или недоступность сети).")
        sys.exit(1)
